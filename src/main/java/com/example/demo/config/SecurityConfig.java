    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/swipe-books", "/wishlist/**", "/swipe-books/**", "/wishlist", "/book_pdfs", "/profile/update", "/my-books", "my-books/**").authenticated()  // Explicitly allow authenticated access to wishlist
